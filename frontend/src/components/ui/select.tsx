...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitives.Trigger
    ref={ref}
    className={cn(
      'flex h-9 w-full items-center justify-between gap-2 rounded-md border border-[#1f1f1f] bg-[#111111] px-3 py-2',
      'text-sm text-[#f4f4f5] placeholder:text-[#71717a]',
      'hover:border-[#2f2f2f] transition-colors',
      'focus:outline-none focus:ring-2 focus:ring-[#6366f1] focus:ring-offset-0',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitives.ScrollUpButton
    ref={ref}
    className={cn(
      'flex cursor-default items-center justify-center py-1 text-[#71717a]',
      className
    )}
    {...props}
  >
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitives.Portal>
    <SelectPrimitives.Content
      ref={ref}
      className={cn(
        'relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border border-[#1f1f1f] bg-[#111111] shadow-xl shadow-black/50',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitives.Label
    ref={ref}
    className={cn(
      'px-2 py-1.5 text-xs font-semibold text-[#71717a] uppercase tracking-wider',
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitives.Item
    ...
    className={cn(
      ...
      'text-sm text-[#f4f4f5] outline-none',
      'focus:bg-[#1a1a1a] focus:text-[#f4f4f5]',
      'data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      'data-[highlighted]:bg-[#6366f1]/20 data-[highlighted]:text-[#818cf8]',
      'transition-colors',
      className
    )}
    {...props}
